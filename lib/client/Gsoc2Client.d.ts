...
import { ClientConfig, GetAllOptions, GetOptions, CreateOptions, UpdateOptions, DeleteOptions, Gsoc2ClientOptions } from '../types/Gsoc2Client';
import { IEncryptSymmetricOutput } from '../types/utils';
declare class Gsoc2Client {
    cache: {
     ...
     */
    constructor({ token, tokenJson, siteURL, debug, cacheTTL }: Gsoc2ClientOptions);
    /**

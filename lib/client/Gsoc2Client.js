...
var Gsoc2Client = /** @class */ (function () {
    /**
     * Create an instance of the Gsoc2 client
     * @param {Object} obj
     * @param {String} obj.token - an Gsoc2 Token scoped to a project and environment
     * @param {Boolean} debug - whether debug is on
     * @param {Number} cacheTTL - time-to-live (in seconds) for refreshing cached secrets.
     */
    function Gsoc2Client(_a) {
        var _b = _a.token, token = _b === void 0 ? undefined : _b, _c = _a.tokenJson, tokenJson = _c === void 0 ? undefined : _c, _d = _a.siteURL, siteURL = _d === void 0 ? variables_1.GSOC2_URL : _d, _e = _a.debug, debug = _e === void 0 ? false : _e, _f = _a.cacheTTL, cacheTTL = _f === void 0 ? 300 : _f;
        this.cache = {};
    ...
    */
    Gsoc2Client.prototype.getAllSecrets = function (options) {
     ...
     */
    Gsoc2Client.prototype.getSecret = function (secretName, options) {
        if (options === void 0) { options = {
            type: "personal",
            environment: "dev",
            path: "/"
     ...
     */
    Gsoc2Client.prototype.createSecret = function (secretName, secretValue, options) {
        if (options === void 0) { options = {
            environment: "dev",
            type: "shared",
            path: "/"
     ...
     */
    Gsoc2Client.prototype.updateSecret = function (secretName, secretValue, options) {
        if (options === void 0) { options = {
            type: "shared",
            environment: "dev",
            path: "/"
     ...
     */
    Gsoc2Client.prototype.deleteSecret = function (secretName, options) {
        if (options === void 0) { options = {
            environment: "dev",
            type: "shared",
            path: "/"
     ...
     */
    Gsoc2Client.prototype.createSymmetricKey = function () {
     ...
     */
    Gsoc2Client.prototype.encryptSymmetric = function (plaintext, key) {
     ...
     */
    Gsoc2Client.prototype.decryptSymmetric = function (ciphertext, key, iv, tag) {

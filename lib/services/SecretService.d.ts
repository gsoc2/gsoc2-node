...
import { ClientConfig } from '../types/Gsoc2Client';
/**
 * Class for secret-related actions
 */
export default class SecretService {
    static populateClientWorkspaceConfig(clientConfig: ClientConfig): Promise<import("../types/Gsoc2Client").WorkspaceConfig>;
    /**
